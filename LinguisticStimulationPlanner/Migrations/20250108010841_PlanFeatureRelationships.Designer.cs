...
namespace LinguisticStimulationPlanner.Migrations
{
    ...
    [Migration("20250108010841_PlanFeatureRelationships")]
    partial class PlanFeatureRelationships
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LinguisticStimulationPlanner.Models.PlanGoalToy", b =>
                {
                    b.Property<int>("PlanId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("PlanId", "GoalId", "ToyId");

                    b.HasIndex("GoalId");

                    b.HasIndex("ToyId");

                    b.ToTable("PlanGoalToys");
                });
            ...
            modelBuilder.Entity("LinguisticStimulationPlanner.Models.PlanGoalToy", b =>
                {
                    ...
                    b.HasOne("LinguisticStimulationPlanner.Models.PlanGoal", null)
                        .WithMany("PlanGoalToys")
                        .HasForeignKey("PlanId", "GoalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
